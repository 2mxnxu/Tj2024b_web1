...
public class VisitController extends HttpServlet{
	// 1. 방문록 등록		: POST 		URL : http://localhost:8080/tj2024b_web1/dey03/visit2 
	//매개변수 : BODY					매개변수 예] {"content" :"안녕", "age" : "30"}
	// 반환타입 : application/json		매개변수 예] true
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		// 1. HTTP로 부터 요청 받은 HTTP HEADER BODY(본문) dto 파싱(변환) 가져오기.
	...
	// 2. 방문록 전체 조회	: GET		URL : http://localhost:8080/tj2024b_web1/dey03/visit2 
	// 반환타입 : application/json		매개변수 예] {"num" : 1, "content" : "안녕1", "age" : "30"}
	@Override
	...
	//매개변수	: BODY					매개변수 예] {"num" : 3, "content" : "수정안녕", "age" : "30"}
	// 반환타입 : application/json		매개변수 예] true
	@Override
	...
	// 4. 방문록 삭제		: DELETE	URL : http://localhost:8080/tj2024b_web1/dey03/visit2?num=1
